...
<div class="container">
 ...
 <div class="w2-col m7">
      ...
      <div class="w3-container w3-card w3-white w3-round w3-margin"><br>
        ...
        <button type="submit"  class="w3-button w3-theme-d2 w3-margin-bottom"><i class="fa fa-eye"></i> Editar </button>
        </form>  
        ...
        <input type = "hidden" name = "_token" value="{{ csrf_token()}}"> 
        <input type="hidden" name="idUsr" value="{{$usuarios[$i]->id}}"> 
        <button type="submit" class="w3-button w3-theme-d1 w3-margin-bottom"><i class="fa fa-thumbs-up"></i>  Eliminar </button> 
        </form>   
